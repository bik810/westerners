...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center bg-[#0c0b4a] text-white">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 bg-black opacity-30"></div>
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#0c0b4a] opacity-70"></div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            {currentUser ? (
              ...
              <>
                ...
                <Link href="/login" className="bg-yellow-500 hover:bg-yellow-600 text-[#0c0b4a] font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
                  로그인
                </Link>
              </>
            )}
        ...
        <div className="absolute bottom-10 left-0 right-0 flex justify-center">
          <a href="#about" className="animate-bounce text-yellow-300">
      ...
      <section id="about" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-[#0c0b4a] mx-auto"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
              <div className="h-3 bg-[#0c0b4a]"></div>
              <div className="p-8">
                <div className="w-16 h-16 bg-[#0c0b4a]/10 text-[#0c0b4a] rounded-full flex items-center justify-center mb-6 mx-auto">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* 최근 갤러리 섹션 */}
      <section className="py-20 bg-[#0c0b4a] text-white">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mt-10">
            <Link href={currentUser ? "/gallery" : "/login"} className="bg-yellow-500 hover:bg-yellow-600 text-[#0c0b4a] font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg inline-block">
